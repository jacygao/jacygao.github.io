...
> "With a command you tell a system to do X. With an event you let a system know that Y has happened." - [Martin Fowler](https://martinfowler.com/eaaDev/EventNarrative.html)
